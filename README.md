...
5. [Generating Cluster PPD File]: This commit facilitates genertion of ppd file for the cluster, the ppd file contains options supported by all printers in the cluster and the constraints. 
***
### Commits Link
